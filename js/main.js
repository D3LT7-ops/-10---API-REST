...
const API_CONFIG = {
    ...
    BASE_URL: 'https://api.weatherstack.com/current.json',
    FORECAST_URL: 'https://api.weatherstack.com/forecast.json',
    HISTORY_URL: 'https://api.weatherstack.com/historical.json'
};
